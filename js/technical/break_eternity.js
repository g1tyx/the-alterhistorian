  ...
  function () {
     ...
     */
  	...
  	Decimal.prototype.div = function (value) {
  		if (D(value).eq(0)) return D(Infinity);
     ...
     */
  	...
  	Decimal.prototype.absLog10 = function () {
  		return D(this.e + Math.log10(Math.abs(this.m)));
  	};

  	Decimal.prototype.pLog10 = function () {
  		return this.m <= 0 || this.e < 0 ? D(0) : this.log10();
  	};
  	...
  	Decimal.prototype.log = function (base) {
  		...
  		return D(Math.LN10 / Math.log(base)).mul(this.log10());
  	};
     ...
     */
  	...
  	Decimal.prototype.mDown = function () {
  		return Decimal.fromMantissaExponent(this.m - 1e-15, this.e);
  	};
  	Decimal.prototype.mUp = function () {
  		return Decimal.fromMantissaExponent(this.m + 1e-15, this.e);
  	};
...
function D(a) { return new Decimal(a); }